...
async function setupDatabase() {
    try {
        ...
        console.log('Menghapus tabel "recipes" jika ada...');
        await db.query('DROP TABLE IF EXISTS recipes CASCADE;');
        console.log('Tabel "recipes" berhasil dihapus (jika ada).');

        console.log('Membuat tabel "recipes"...');
        await db.query(`
        ...
        `);
        console.log('Tabel "recipes" berhasil dibuat.');

        console.log('Memasukkan resep default...');
        for (const recipe of defaultRecipes) {
            await db.query(
                ...
                [
                    recipe.name,
                    recipe.desc, // The object property is still 'desc'
                    recipe.image,
                    recipe.history,
                    recipe.tools,
                    recipe.ingredients,
        ...
        console.log(`${defaultRecipes.length} resep default berhasil dimasukkan.`);
        ...
        // It's good practice to end the pool if this script is meant to run once and exit
        // However, for serverless functions, the pool might be managed differently.
        // For a one-off setup script, ending it is appropriate.
        // await db.end(); // db.end() is not exposed by my simple db.js
    }
}
